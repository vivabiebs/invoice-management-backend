...
public class InvoiceService {
    ...
    public java.util.List<Invoice> getInvoicesByBiller(Biller biller) {
        return invoiceRepository.findAllByBiller(biller);
    }

    public java.util.List<Invoice> getInvoicesByPayer(Payer payer) {
        return invoiceRepository.findAllByPayer(payer);
    }
}
